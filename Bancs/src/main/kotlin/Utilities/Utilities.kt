 ...
 * @return outputValue Output value
 */
fun readSentence(pMessageIn: String): String{
 ...
 * @return outputValue Output value
 */
fun readChar(pMessageIn: String): Char{
 ...
 * @return outputValue Output value
 */
fun readChar(pMessageIn: String, pCase: Int
): Char{
 ...
 */
fun readIntRange(pMessageIn: String, pMin: Int, pMax: Int): Int {
    println(pMessageIn)
...
/**
 * This method can be used to read a Yes/No string value from the user through keyboard using java.util.Scanner
 * and returns boolean
 * @author annacano0
 * @since 22/12/2023
 * @param pMessageIn Input message to be shown to the user
 ...
 * @return outputValue Output value (boolean)
 */
fun readStringYesNo(pMessageIn: String): Boolean {
    var inputCorrecte: Boolean = true
    var inputUsuari: String = ""
    var outputValue: Boolean = false
    do {
